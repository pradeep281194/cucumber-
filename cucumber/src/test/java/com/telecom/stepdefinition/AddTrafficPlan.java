...
public class AddTrafficPlan {
	...
	@Given("user click on addtraffplan button")
	public void user_click_on_addtraffplan_button() {
	...
	public void user_verify_Congratulation_is_generted() {
	...
	public void user_enter_all_fields_using_one_l_dim_list(DataTable dataTable) {
	...
	public void user_enter_all_fields_using_one_dim_map(DataTable dataTable) {
		Map<String,String> datas = dataTable.asMap(String.class,String.class);
		driver.findElement(By.name("rental")).sendKeys(datas.get("rental"));
		driver.findElement(By.name("local_minutes")).sendKeys(datas.get("local"));
		...
		driver.findElement(By.name("minutes_charges")).sendKeys(datas.get("minutes"));
		driver.findElement(By.name("inter_charges")).sendKeys(datas.get("inter"));
		driver.findElement(By.id("sms_charges")).sendKeys(datas.get("sms"));
	}
